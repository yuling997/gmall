...
public class CategoryController {
    ...
    @GetMapping
    public Resp<List<CategoryEntity>> queryCategoreiesByLevelOrPid(@RequestParam(value = "level", defaultValue = "0") Integer level,
                                                                   @RequestParam(value = "parentCid", required = false)Long pid){
        List<CategoryEntity> categoryEntities = this.categoryService.queryCategoreiesByLevelOrPid(level, pid);
